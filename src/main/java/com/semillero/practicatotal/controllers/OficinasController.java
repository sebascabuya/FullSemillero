...
public class OficinasController {
	...
	@DeleteMapping(value="/eliminaroficina/{oficinaId}")
	public void eliminarOficina(@PathVariable(value="oficinaId") Integer oficinaId) {
		oficinasRepository.deleteById(oficinaId);
	}
}
